...
public class Triangle extends Forme {
	 ...
	 */
	public Triangle(final String n, final Position p1, final Position p2, final Position p3) {
		setNom(n);
		this.haut = p1.clone();
	...
	@Override
	public void draw() {
		System.out.println("Triangle(sommet1=(" + haut.getX() + "," + haut.getY() + "),sommet2=(" + gauche.getX() + ","
				+ gauche.getY() + "),sommet3=(" + droite.getX() + "," + droite.getY() + "))");
	}
}