...
public class DataBase {
	...
	public static void createAllTables(final Connection connect) throws SQLException {
		String forme = "CREATE TABLE Forme (" + "Nom varchar(30)," + "PRIMARY KEY (Nom)" + ")";
		String cercle = "CREATE TABLE Cercle (" + "Nom varchar(30)," + "Centre_X int," + "Centre_Y int," + "Rayon int,"
				+ "PRIMARY KEY (Nom)," + "FOREIGN KEY (Nom) REFERENCES Forme (Nom)" + ")";
		String carre = "CREATE TABLE Carre (" + "Nom varchar(30)," + "Centre_X int," + "Centre_Y int," + "Longueur int,"
				+ "PRIMARY KEY (Nom)," + "FOREIGN KEY (Nom) REFERENCES Forme (Nom)" + ")";
		String rectangle = "CREATE TABLE Rectangle (" + "Nom varchar(30)," + "Centre_X int," + "Centre_Y int,"
				+ "Longueur int," + "Hauteur int," + "PRIMARY KEY (Nom)," + "FOREIGN KEY (Nom) REFERENCES Forme (Nom)"
				+ ")";
		String triangle = "CREATE TABLE Triangle (" + "Nom varchar(30)," + "Sommet1_X int," + "Sommet1_Y int,"
				+ "Sommet2_X int," + "Sommet2_Y int," + "Sommet3_X int," + "Sommet3_Y int," + "PRIMARY KEY (Nom),"
				+ "FOREIGN KEY (Nom) REFERENCES Forme (Nom)" + ")";
		String groupe = "CREATE TABLE Groupe (" + "Nom varchar(30)," + "PRIMARY KEY (Nom),"
				+ "FOREIGN KEY (Nom) REFERENCES Forme (Nom)" + ")";
		String groupeForme = "CREATE TABLE GroupeForme (" + "NomGroupe varchar(30)," + "NomForme varchar(30),"
