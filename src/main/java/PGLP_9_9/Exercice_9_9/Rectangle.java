...
public class Rectangle extends Forme {
	 ...
	 */
	public Rectangle(final String n, final Position p, final int l, final int h) throws Exception {
		setNom(n);
		this.centre = p.clone();
		setLongueur(l);
		setHauteur(h);
	...
	@Override
	public void draw() {
		System.out.println("Rectangle(centre=(" + centre.getX() + "," + centre.getY() + "),longueur=" + longueur
				+ ",hauteur=" + hauteur + ")");
	}
}